...
public class MVVMApiFragment extends Fragment implements BaseMVVMApi {
    private HashMap<String, HashMap<String, Observable>> observableHashMap = new HashMap<>();

    public static MVVMApiFragment newInstance() {
        Bundle args = new Bundle();
        MVVMApiFragment fragment = new MVVMApiFragment();
